...
from app.routers import audit, auth, public_sub, servers, subscriptions, tools, traffic, users
...
app.include_router(traffic.router, dependencies=[Depends(require_admin)])
